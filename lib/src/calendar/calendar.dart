...
class ETC implements Calendar {
  ...
  ///
  /// For example. to create a [ETC] object representing the 1st of ጷጉሜን 2011,
  ///
  ///
  /// ```
  ...
  Iterable<List<dynamic>> monthDays(
    ...
    var monthBeginning = _monthRange()[0];
    var daysInMonth = _monthRange()[1];
  ...
  Iterable<List<dynamic>> _monthDays(int year, int month,
      {bool geezDay = false, bool weekDayName = false}) sync* {
    var yr = EtDatetime(year: year, month: month);
